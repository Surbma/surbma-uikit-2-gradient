...
/*
Plugin Name: Surbma - UIkit 2 - Gradient
...
Text Domain: surbma-uikit-2-gradient
...
// Localization
function surbma_uikit_2_gradient_init() {
	load_plugin_textdomain( 'surbma-uikit-2-almost-flat', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
add_action( 'plugins_loaded', 'surbma_uikit_2_gradient_init' );

function surbma_uikit_2_gradient_enqueue_scripts() {
...
add_action( 'wp_enqueue_scripts', 'surbma_uikit_2_gradient_enqueue_scripts' );
